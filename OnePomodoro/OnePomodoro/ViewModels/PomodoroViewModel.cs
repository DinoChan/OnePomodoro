...
namespace OnePomodoro.ViewModels
{
    ...
    {
        private TimeSpan PomodoroLength => TimeSpan.FromSeconds(10);// TimeSpan.FromMinutes(SettingsService.Current == null ? 25 : SettingsService.Current.PomodoroLength);
        private TimeSpan ShortBreakLength => TimeSpan.FromSeconds(10);// TimeSpan.FromMinutes(SettingsService.Current == null ? 5 : SettingsService.Current.ShortBreakLength);
        private TimeSpan LongBreakLength => TimeSpan.FromSeconds(10);//TimeSpan.FromMinutes(SettingsService.Current == null ? 15 : SettingsService.Current.LongBreakLength);
